...
int main()
{
    ...
    volatile int counter = 10; // used to 0


    /*while (true)
    {
        //Toggles the LED seems to alternate the leds with counter so 200 is all leds = 0 and 201 all leds = 1
        ledRed = !ledRed;
        ledGreen = !ledGreen;
        ledBlue = !ledBlue;
    ...
    while (counter < 16) //used to be 10 then 5
    {
        //Toggle the LED
        ledBlue = !ledBlue;
